...
Count.prototype.__addContainer = function(container) {
    console.log(c.red.bgWhite('adding container!'));
...
Count.prototype.__checkCount = function() {
	...
	this.__checkTimer = setTimeout(this.__doCheckCount.bind(this), 30000);
...
Count.prototype.__doCheckCount = function() {
	...
	var spares = [];
	var installings = [];
//	console.log('this cointainers', this.containers);
